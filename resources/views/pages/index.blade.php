...
<div class="">
    ...
    <h1 class="text-lg font-normal text-grayscale-500 mb-3"><span class="text-xl font-bold text-primary-600">Hello,</span> Selamat Datang</h1>
    <h3 class="text-sm font-light text-grayscale-500 mb-8">Di Retail Cluster Annual Business Meeting 2022.</h3>
    <label for="code" class="text-sm font-bold text-grayscale-600 mb-1 block">Nomor Handphone</label>
